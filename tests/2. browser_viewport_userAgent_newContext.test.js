...
test('Test Cases Name',  async ({browser})=> {// here browser is fixture and that extract from @playwright/test module the test can understand the browser fixture without import
    ...
    //e two lines rayalisina avasarme ledu playwright manaki e page ane property tho a two files nee handle chesthundi but manaki browser lunch lo and page opening emina configurations cheyali ante e two line rastham
