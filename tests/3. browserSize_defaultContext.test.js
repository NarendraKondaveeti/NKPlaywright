...
test('@test2 Test Cases Name',  async ({browser})=> {
    ...
    // actually manam new fresh browser and new page use cheyali anukunappudu mannam e 'const context = await browser.newContext();' , 'const page = await bro.newPage(); ' 
    //e two lines rayalisina avasarme ledu playwright manaki e page ane property tho a two files nee handle chesthundi but manaki browser lunch lo and page openiing emina configurations cheyali ante e two line rastham
    //like const context1 = await browser.newContext({viewport: { width: 1280, height: 720 },userAgent: 'MyUserAgent'}); ante browser a size lo open avali anedi ivochu
...
/*
Page Object in Playwright:- Purpose: The Page object represents a single tab or page in the browser and provides various methods to interact with the page's content.
Capabilities:-
