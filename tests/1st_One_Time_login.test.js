...
await context.newPage(): context.newPage() ane di Playwright provide chesina method. 
Idi a context lo oka new page (tab) ni create chestundi.

3. await context.storageState({path: '1stlogin.json'});
...
4. webContext = await browser.newContext({storageState: '1stlogin.json'});
webContext: Idi manam define chesina variable name.
await browser.newContext({storageState: '1stlogin.json'}): Ikkada browser.newContext() Playwright provide chesina method, 
idi new context ni create chestundi. {storageState: '1stlogin.json'} ane object lo storage state ni initialize chesthunnaru, 
adi user-defined statement.

5. const page = await webContext.newPage();
const: Manam define chesina keyword, variable ni declare cheyyadaniki.
page: Manam petti na variable name, idi user-defined statement.
...
E methods Playwright provide chesindi and manaki browser automation lo help chesthayi. 
await ane keyword asynchronous operations ki wait cheyyadaniki use chestham.
*/
