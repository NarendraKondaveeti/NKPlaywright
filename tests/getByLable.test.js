...
test('Playwright Special locators', async ({ page }) => {
    ...
    /* npx playwright test --ui  idi okka test execution command idi run chesthe execution start avakundaa playwright okka UI lo open chesthundi
    adulo project vunna ani files vuntai alage adena file mutiple cases vunte each case ki run button chupisthundi, manam kavali ante ani test files nee okka sari execute cheyosu 
